package com.wutl.syscenter.utils.redis;

import com.wutl.syscenter.utils.sys.SpringUtil;
...
public class RedisUtil {
    ...
    public static void initRedisTemplate() {
        if (redisTemplate == null) {
            ...
            redisTemplate = SpringUtil.getBean("stringRedisTemplate", RedisTemplate.class);
        }
    }
